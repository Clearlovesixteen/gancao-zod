...
**Goal:** Build, test, and document a private `@gancao` Zod toolkit monorepo for browser, Express, and NestJS applications.
...
2. Implement and test the normalized result API in `@gancao/zod-core`.
3. Implement and test reusable schemas in `@gancao/zod-presets`.
