...
describe("contact presets", () => {
  ...
  it.each(["13800138000", "19912345678"])("accepts Chinese mobile %s", (value) => {
...
describe("date presets", () => {
  ...
  it("validates ISO date times with offsets", () => {
    expect(isoDateTimeSchema.safeParse("2026-07-14T09:30:00Z").success).toBe(true);
    expect(isoDateTimeSchema.safeParse("2026-07-14 09:30:00").success).toBe(false);
  });
});
